...
import { Image, Text, View, ImageBackground, ScrollView, Button, Pressable, Modal, StatusBar, ActivityIndicator, Alert } from 'react-native';
...
const CoreComponents = () => {
    ...
    <Button title='Alert2' onPress={() => Alert.alert("Invalid data!", "Dob incoorect")} />
    <Button title='Alert3' onPress={() => Alert.alert("Invalid data!", "Dob incoorect", [
      { text: 'Cancel', onPress: () => console.log("Cancle pressed") },
      { text: "Ok", onPress: () => console.log("OK pressed") }
    ])} /> */}

            {/* ---first component--- */}
            {/* <Greet name="Mohiuddin" />
    <Greet name="Nipa" /> */}
